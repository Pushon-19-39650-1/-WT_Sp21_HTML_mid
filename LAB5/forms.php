		...
		<form action="" method="post">
			...
			<tr>
				...
				<tr>
					...
					<td> : <input type="checkbox" value="Friend/Colleague" name="Where did you hear about us?[]">Friend/Colleague
					     <input type="checkbox" value="Google" name="Where did you hear about us?[]">Google
					     <input type="checkbox" value="Blog post" name="Where did you hear about us?[]">Blog post
						 <input type="checkbox" value="News Article" name="Where did you hear about us?[]">News Article
